...
public:
    ...
    [[nodiscard]] EntityID get_parent_id() const
    {
        return this->parent_id;
    }
    [[nodiscard]] explicit operator EntityID()
    {
        return this->parent_id;
    }
};
...
public:
    ...
    // useful tooling
    EntityID add_child(EntityManager& manager, std::unique_ptr<Entity> child_entity,
    ...
    [[nodiscard]] std::optional<std::string> get_child_name_by_index(EntityManager const& manager,
                                                                     size_t index) const;
    ...
    [[nodiscard]] Entity const& get_child_by_id(EntityManager const& manager,
                                                EntityID child_id) const;
    [[nodiscard]] Entity& get_child_by_index(EntityManager& manager, size_t index) const;
    [[nodiscard]] Entity const& get_child_by_index(EntityManager const& manager,
                                                   size_t index) const;
    [[nodiscard]] Entity& get_child_by_name(EntityManager& manager, std::string_view name) const;
    [[nodiscard]] Entity const& get_child_by_name(EntityManager const& manager,
                                                  std::string_view name) const;
    [[nodiscard]] EntityID get_child_id_by_index(EntityManager const& manager, size_t index) const;
    [[nodiscard]] EntityID get_child_id_by_name(EntityManager const& manager,
                                                std::string_view name) const;
...
public:
    ...
    std::optional<std::string> get_child_name_by_index(EntityID parent_id,
